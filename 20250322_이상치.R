...
students$z_score=
  (students$Score-mean(students$Score)/sd(students$Score))
#View(students)
...
# z 스코어는 정규분포에서 각 값이 평균으로 얼마나 떨어져 있는지 알려줍니다

# emp.csv를 이용해 사원 급여를 z-스코어를 사용하여 이상치 탐지
# 임계값은 2로 설정
# 임계값이 2 이상인 사원 정보 조회
